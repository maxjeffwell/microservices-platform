...
/**
 * POST /metabase/embed-token/dashboard/:dashboardId
...
/**
 * POST /metabase/embed-token/question/:questionId
...
router.post('/embed-token/sdk', (req, res) => {
  try {
    ...
    const payload = {
      iss: 'microservices-platform-analytics',
